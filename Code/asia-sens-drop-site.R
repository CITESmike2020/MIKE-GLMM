...
# Get the data and restrict to Asia only
...
write.csv(drop.eff, file="asia.sens.drop.YearP.eff.csv", row.names=FALSE)
...
head(drop.eff)
write.csv(drop.eff, file="asia.sens.drop.YearP.eff.MM.csv", row.names=FALSE)
...
head(drop.eff)
write.csv(drop.eff, file="asia.sens.drop.YearP.eff.MMw.csv", row.names=FALSE)
